...
%Purpose: check factor product and reduced factor function
...
%find the reduced factor
 %reduced to C = 1, as in Figure 4.5
PhiAB_Red = hw1FactorReduce( PhiABC, [3], [1] );   
hw1PrintFactor(PhiAB_Red);
%reduced to C = 2, to show that it is different
PhiAB_Red = hw1FactorReduce( PhiABC, [3], [2] );    
hw1PrintFactor(PhiAB_Red);
function [theta_est, P_theta, inlier_indices] = estimate_displacement_ransac(R_p, G_p, R)
...
% run Gauss-Newton:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[theta_est, P_theta] = estimate_pose_GN(G_p(:,inlier_indices), R_p(:,inlier_indices), R, best_theta,best_score);
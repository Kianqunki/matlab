% Case 4: 3 robot poses, 3 landmarks, not always observed
close all
clear all
...
r_m = [x1m y1m phi1m; x2m y2m phi2m; 0 0 0]';
r_a = [ 0 0 0; x2a y2a phi2a; x4a y4a phi4a]';
r_all = [ x1a y1a phi1a; x2a y2a phi2a; x4a y4a phi4a]';
% define the landmark vectors
l_m = [m1m n1m; m2m n2m; m3m n3m]';
l_a = [m1a n1a; m2a n2a; m3a n3a]';
l_all = [m1a n1a; m2a n2a; m3a n3a]';

% define S_m(k)
S_m = [1 1 1; 1 0 0; 0 0 0];
% define S_a(k')
S_a = [0 0 0; 1 0 0; 0 1 1];
